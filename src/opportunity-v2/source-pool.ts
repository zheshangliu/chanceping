...
export const DEFAULT_OPPORTUNITY_V2_SOURCES: OpportunityV2Source[] = [
  ...
  { id: "asef-culture360-opportunities", name: "ASEF culture360 Opportunities", url: "https://culture360.asef.org/opportunities/", region: "GLOBAL", priority: "P1", types: ["craft", "heritage", "open_call", "grant", "residency"], radars: ["ich"], enabled: true, status: "PENDING", last_fetch_at: null },
  { id: "on-the-move-open-calls", name: "On the Move Open Calls", url: "https://on-the-move.org/news/deadlines", region: "GLOBAL", priority: "P1", types: ["open_call", "grant", "residency", "mobility"], radars: ["ich"], enabled: true, status: "PENDING", last_fetch_at: null },
  ...
  { id: "1zj-cultural-competition", name: "第一征集网｜全球征集网", url: "https://www.1zj.com/index.php?a=mlists&c=index&catid=85&cid=91&m=content&page=1", region: "CN", priority: "P0", types: ["competition", "cultural_creative", "design", "gift"], radars: ["ich"], enabled: true, status: "PENDING", last_fetch_at: null },
  { id: "chuangyisai-cultural", name: "创意赛网", url: "https://www.chuangyisai.com/zjds/gycp/wcsj", region: "CN", priority: "P0", types: ["competition", "cultural_creative", "heritage", "tourism_product", "design"], radars: ["ich"], enabled: true, status: "PENDING", last_fetch_at: null },
  ...
  { id: "proc-cn-ccgp", name: "中国政府采购网", url: "https://www.ccgp.gov.cn/cggg/dfgg/index.htm", region: "CN", priority: "P0", types: ["procurement", "buyer_demand", "official_listing"], radars: ["ich"], enabled: false, status: "PENDING", last_fetch_at: null },
  { id: "proc-cn-cib", name: "兴业银行集中采购管理平台", url: "https://cg.cib.com.cn/cms/default/webfile/index.html", region: "CN", priority: "P0", types: ["procurement", "supplier_application", "official_listing"], radars: ["ich"], enabled: false, status: "PENDING", last_fetch_at: null },
  { id: "proc-global-ocp", name: "Open Contracting Data Registry｜Wales Sell2Wales", url: "https://data.open-contracting.org/en/publication/119/download?name=2026.jsonl.gz", region: "GLOBAL", priority: "P0", types: ["procurement", "buyer_demand", "ocds", "open_data"], radars: ["ich"], enabled: false, status: "PENDING", last_fetch_at: null },
  { id: "proc-eu-ted", name: "TED 欧盟招标公告", url: "https://api.ted.europa.eu/v3/notices/search", region: "GLOBAL", priority: "P0", types: ["procurement", "buyer_demand", "official_api"], radars: ["ich"], enabled: false, status: "PENDING", last_fetch_at: null },
  { id: "proc-wb", name: "World Bank Procurement Notice", url: "https://datacatalogapi.worldbank.org/dexapps/fone/api/apiservice?datasetId=DS00979&resourceId=RS00909&type=json", region: "GLOBAL", priority: "P0", types: ["procurement", "buyer_demand", "official_api"], radars: ["ich"], enabled: false, status: "PENDING", last_fetch_at: null },
  ...
  { id: "proc-cn-gzsun", name: "广州阳光采购服务平台", url: "https://www.gzsun.com.cn/", region: "CN", priority: "P0", types: ["procurement", "buyer_demand", "official_listing"], radars: ["ich"], enabled: false, status: "PENDING", last_fetch_at: null },
  ...
  { id: "cnaf-guides", name: "国家艺术基金申报指南", url: "https://www.cnaf.cn/guide.html", region: "CN", priority: "P0", types: ["grant", "funding", "official_listing"], radars: ["ich"], enabled: true, status: "PENDING", last_fetch_at: null },
