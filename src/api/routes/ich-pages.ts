...
<style>.ich-contact-page{padding:42px 0 12px}.ich-contact-hero{display:grid;grid-template-columns:220px minmax(0,1fr) 330px;gap:42px;padding:34px 0 38px;border-top:1px solid var(--line);border-bottom:1px solid var(--line)}.ich-contact-heading h1{margin:8px 0 12px;font:34px/1.25 "Songti SC","Noto Serif SC",serif}.ich-contact-heading>p:last-child{color:var(--muted);font-family:serif}.ich-contact-copy>p{margin:0 0 20px;color:#544f46;font:17px/1.85 "Songti SC","Noto Serif SC",serif}.ich-contact-reasons{border-top:1px solid var(--line)}.ich-contact-reasons p{display:grid;grid-template-columns:34px minmax(0,1fr);gap:12px;margin:0;padding:14px 0;border-bottom:1px solid var(--line)}.ich-contact-reasons span{color:var(--clay);font:18px/1.4 "Times New Roman",serif}.ich-contact-name{white-space:nowrap}.ich-contact-details{display:flex;flex-wrap:wrap;gap:10px 24px;margin-top:22px;font-style:normal}.ich-contact-details a{color:var(--indigo);font-weight:700}.ich-contact-details span{color:var(--muted)}.ich-contact-qr{margin:0;padding:12px;background:#fff;border:1px solid var(--line);align-self:start}.ich-contact-qr img{display:block;width:100%;height:auto}.ich-contact-qr figcaption{text-align:center;color:var(--muted);font-size:12px;padding:8px 0 2px}.ich-principles{display:grid;grid-template-columns:220px minmax(0,1fr);gap:42px;padding:34px 0}.ich-principles h2{margin:8px 0 0;font:28px/1.3 "Songti SC","Noto Serif SC",serif}.ich-principles>div{color:var(--muted)}.ich-principles>div p:first-child{margin-top:0}@media(max-width:1040px){.ich-contact-hero{grid-template-columns:180px minmax(0,1fr) 280px}.ich-principles{grid-template-columns:180px minmax(0,1fr)}}@media(max-width:820px){.ich-contact-page{padding-top:24px}.ich-contact-hero{grid-template-columns:1fr;gap:22px;padding-top:24px}.ich-contact-heading h1{font-size:31px}.ich-contact-copy>p{font-size:16px}.ich-contact-qr{width:min(100%,360px);justify-self:center}.ich-principles{grid-template-columns:1fr;gap:10px}.ich-principles h2{font-size:25px}}@media(max-width:520px){.ich-contact-details{display:block}.ich-contact-details span{display:block;margin-top:8px}.ich-contact-reasons p{grid-template-columns:28px minmax(0,1fr)}}</style>
...
export function ichPagesRoutes(options: IchReadRouteOptions = {}): Hono {
  ...
  app.get("/source-principles", (c) => c.html(shell(
    ...
    `<main class="ich-contact-page"><section class="ich-contact-hero"><header class="ich-contact-heading"><p class="ich-kicker">CUSTOM RADAR</p><h1>定制你的机会雷达</h1><p>把真正重要的机会，变成一套长期运行的发现系统。</p></header><div class="ich-contact-copy"><p>「非遗机会雷达」由盯机会 ChancePing 系统持续收集、整理与更新。ChancePing 也可以根据个人、创业团队、企业或机构的实际目标，定制专属机会雷达，持续盯住比赛、客户线索、采购项目、合作机会、政策扶持或行业信息。</p><div class="ich-contact-reasons"><p><span>01</span>如果你对本非遗机会雷达有任何改进意见或建议，希望让更多非遗从业者通过本雷达获益，欢迎联系。</p><p><span>02</span>如果你希望为自己的业务建立一套长期运行的机会雷达，欢迎联系开发者 <strong class="ich-contact-name">Jason 刘哲赏</strong>。</p></div><address class="ich-contact-details"><a href="mailto:sunny251610056@gmail.com">sunny251610056@gmail.com</a><span>微信：<strong>liuzheshangwx</strong></span></address></div><figure class="ich-contact-qr"><img src="/assets/ich-jason-wechat-qr.jpg" width="1194" height="1575" alt="开发者 Jason 刘哲赏的微信二维码"><figcaption>微信扫码联系 Jason</figcaption></figure></section><section class="ich-principles"><p class="ich-kicker">SOURCE &amp; REVIEW</p><h2>来源与审核原则</h2><div><p>我们优先采用政府公告、官方报名页和主办方正式通知。聚合页只作为发现线索，关键报名条件必须回到第一方来源核验。</p><p>未经审核的提交不会公开；无法确认的字段会明确标记，已撤回或失效的机会会离开当前列表。</p></div></section></main>`,
  )));
