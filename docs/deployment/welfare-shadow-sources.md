...
首轮 12 个候选中，`OFF-N-001`（中国政府采购网采购公告）、`OFF-N-004`（全国公共资源交易平台）、`OFF-GD-004`（广东省总工会渠道合作）与 `WEL-001`（关爱通供应商招募）已通过影子期并进入正式解析器批次。影子队列保留 8 个：`OFF-N-002`、`OFF-GD-002`、`OFF-GZ-001`、`OFF-SZ-001`、`OFF-SZ-002`、`OFF-ZJ-001`、`ORG-001`、`ORG-002`。
