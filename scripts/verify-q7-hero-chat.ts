...
async function run() {
  ...
  check("hero chat sidebar renders one current AI event radar window", heroChatJs.includes("hero-sidebar-current-radar") && !heroChatJs.includes("样板间") && !heroChatJs.includes("我的雷达"));
