...
check("source registry contains all 48 planned sources", registry.sources.length === 48 && registry.sourceCount === 48);
...
try {
  validateSourceRegistry({ ...registry, sourceCount: 47 });
