...
check("page explains its ChancePing system basis", js.includes("ChancePing") && js.includes("持续更新"));
...
check("page proof copy attributes navigator updates to ChancePing", js.includes("由盯机会 ChancePing 持续更新") && js.includes("公开 AI 赛事信息"));
