  ...
  try {
    if (confirmedSpec) {
      const semanticSpec: typeof confirmedSpec = {
        ...
        radar_version: {
          version: "V1.0",
          oneSentencePositioning: "员工福利和节日礼品供应商机会雷达",
          targetUser: "员工福利和节日礼品供应商",
          businessContext: "寻找广东、香港企业福利采购、节日礼品招标、供应商入库、渠道合作和潜在客户线索",
          opportunityIntents: ["员工福利采购", "节日礼品招标", "企业合作线索", "渠道合作线索", "潜在客户线索"],
          highValueCriteria: ["采购公告或招标入口", "供应商入库或合作入口", "可联系确认的渠道伙伴或潜在客户"],
          exclusionRules: ["加盟广告", "纯培训课程", "泛趋势文章"],
          prioritySourceArchetypes: ["采购合作 / 供应商入库 / 渠道伙伴 / 潜在客户入口"],
          queryFamilies: [
            {
              familyName: "员工福利采购公告",
              intentType: "direct_opportunity",
              sourceArchetype: "procurement_or_supplier_portal",
              queries: ["广东 员工福利 礼品 采购公告", "香港 corporate gifts procurement supplier"],
              whyThisFamily: "验证直接采购机会可进入重点卡。",
              resultBucket: "direct_opportunity",
            },
            {
              familyName: "供应商入库合作入口",
              intentType: "business_lead",
              sourceArchetype: "procurement_or_supplier_portal",
              queries: ["员工福利 供应商 入库 合作入口", "corporate gifts supplier onboarding"],
              whyThisFamily: "验证可行动业务线索可进入重点区并标注需联系确认。",
              resultBucket: "business_lead",
            },
            {
              familyName: "渠道伙伴目录",
              intentType: "channel_partner_lead",
              sourceArchetype: "reseller_partner_page",
              queries: ["员工福利 礼品 渠道伙伴 经销商目录"],
              whyThisFamily: "验证渠道伙伴线索分层。",
              resultBucket: "channel_partner_lead",
            },
            {
              familyName: "福利采购趋势观察",
              intentType: "watch_signal",
              sourceArchetype: "reference_case_source",
              queries: ["员工福利 采购趋势 预算 观察"],
              whyThisFamily: "验证观察信号保留但不进入重点卡。",
            ...
            },
            {
              ...
              sourceArchetype: "reference_case_source",
              queries: ["员工福利 礼品 项目 案例 复盘"],
              whyThisFamily: "验证参考案例保留但不进入重点卡。",
          ...
          missingConfig: [],
          defaultAssumptions: ["线索类需联系确认，不视为已确认采购或合作机会。"],
          revisionNotes: [],
          resultBuckets: ["direct_opportunity", "business_lead", "channel_partner_lead", "customer_lead", "watch_signal", "reference_case"],
        },
        client_profile: {
