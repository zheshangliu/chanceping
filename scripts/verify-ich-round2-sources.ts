...
function main(): void {
  ...
  console.log(JSON.stringify({ cnyisai: c.length, onezj: z.length, chuangyisai: 1, zjmt: zjm.length, noise_filtered: "PASS", source_status_to_display: "PASS", zjmt_precision: "PASS", participation_scope: "PASS", adapter_registry: "PASS" }, null, 2));
}
