...
const audit = JSON.parse(fs.readFileSync("docs/ich/DS11-C-来源状态统一审计_V1.0.json", "utf8")) as Record<string, unknown>;
assert.equal(audit.stage, "DS11-C");
...
assert.deepEqual(audit.source_ids, ["ccgp", "gd-culture", "yuexiu-notices"]);
