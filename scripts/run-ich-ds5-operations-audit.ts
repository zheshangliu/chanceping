...
const ds3 = JSON.parse(fs.readFileSync(path.resolve("docs/ich/DS3-候选质量运行记录_V1.0.json"), "utf8")) as { gate: string; formal_store_write: boolean; assessments: number; review_required: number; rejected: number };
...
const record = {
  ...
  upstream_runs: { ds4_gate: ds4.gate, ds2_gate: ds2.gate, ds2_candidate_count: ds2.candidate_count, ds3_gate: ds3.gate, ds3_assessments: ds3.assessments, ds3_review_required: ds3.review_required, ds3_rejected: ds3.rejected },
